...
?>
<?php
// Merged from custom/Extension/modules/oj_Events/Ext/Dependencies/event_template_required.php


$dependencies['oj_Events']['event_template_required'] = array(
    'hooks' => array("all"),
    'trigger' => 'true',
    'triggerFields' => array('sign_off_selection_form_c'),
    'onload' => true,
    'actions' => array(
        array(
            'name' => 'SetRequired',
            'params' => array(
                'target' => 'event_template_c',
                'value' => 'equal($sign_off_selection_form_c,1)',
            )
        ),
    ),
);
