...
?>
<?php
// Merged from custom/Extension/modules/oj_Events/Ext/Vardefs/apply_concession.php


$dictionary['oj_Events']['fields']['apply_concession']['name']='apply_concession';
$dictionary['oj_Events']['fields']['apply_concession']['vname']='LBL_APPLY_CONSESSION';
$dictionary['oj_Events']['fields']['apply_concession']['type']='bool';

?>
<?php
// Merged from custom/Extension/modules/oj_Events/Ext/Vardefs/voucher_code.php


$dictionary['oj_Events']['fields']['voucher_code']['name'] = 'voucher_code';
$dictionary['oj_Events']['fields']['voucher_code']['vname'] = 'LBL_VOUCHER_CODE';
$dictionary['oj_Events']['fields']['voucher_code']['type'] = 'varchar';
$dictionary['oj_Events']['fields']['voucher_code']['readonly'] = true;
$dictionary['oj_Events']['fields']['voucher_code']['dependency'] = 'and($apply_concession,true)';
...
$dictionary['oj_Events']['fields']['shortcode_c']['required'] = true;
$dictionary['oj_Events']['fields']['shortcode_c']['len'] = 10;
$dictionary['oj_Events']['fields']['shortcode_c']['dependency'] = '';


?>
<?php
// Merged from custom/Extension/modules/oj_Events/Ext/Vardefs/discount_help.php


$dictionary['oj_Events']['fields']['discount_help']['name'] = 'discount_help';
$dictionary['oj_Events']['fields']['discount_help']['vname'] = 'LBL_DISCOUNT_HELP';
$dictionary['oj_Events']['fields']['discount_help']['type'] = 'text';
$dictionary['oj_Events']['fields']['discount_help']['rows'] = 4;
$dictionary['oj_Events']['fields']['discount_help']['cols'] = 20;
$dictionary['oj_Events']['fields']['discount_help']['dependency'] = 'and($apply_concession,true)';

?>
<?php
// Merged from custom/Extension/modules/oj_Events/Ext/Vardefs/sign_off_invitations_emailing.php


$dictionary['oj_Events']['fields']['sign_off_invitations_emailing']['name'] = 'sign_off_invitations_emailing';
$dictionary['oj_Events']['fields']['sign_off_invitations_emailing']['vname'] = 'LBL_SIGN_OFF_INVITATION_EMAILING';
$dictionary['oj_Events']['fields']['sign_off_invitations_emailing']['type'] = 'bool';
$dictionary['oj_Events']['fields']['sign_off_invitations_emailing']['dependency'] = 'isAdmin()';

?>
<?php
// Merged from custom/Extension/modules/oj_Events/Ext/Vardefs/concession_description.php


$dictionary['oj_Events']['fields']['concession_description']['name'] = 'concession_description';
$dictionary['oj_Events']['fields']['concession_description']['vname'] = 'LBL_CONCESSION_DESCRIPTION';
$dictionary['oj_Events']['fields']['concession_description']['type'] = 'text';
$dictionary['oj_Events']['fields']['concession_description']['required'] = true;
$dictionary['oj_Events']['fields']['concession_description']['audited'] = true;
$dictionary['oj_Events']['fields']['concession_description']['rows'] = 4;
$dictionary['oj_Events']['fields']['concession_description']['cols'] = 20;
$dictionary['oj_Events']['fields']['concession_description']['dependency'] = 'and($apply_concession,true)';

?>
<?php
// Merged from custom/Extension/modules/oj_Events/Ext/Vardefs/template_for_events.php


$dictionary['oj_Events']['fields']['template_for_events'] =
    array(
        'dependency' => '',
        'required' => false,
        'source' => 'non-db',
        'name' => 'template_for_events',
        'vname' => 'LBL_TEMPLATE_FOR_EVENTS',
        'type' => 'relate',
        'massupdate' => false,
        'no_default' => false,
        'comments' => '',
...
$dictionary['oj_Events']['fields']['event_template_id'] =
    array(
        'required' => false,
        'name' => 'event_template_id',
        'vname' => 'LBL_TEMPLATES_FOR_EVENTS_EVENT_TEMPLATE_ID',
        'type' => 'id',
        'massupdate' => false,
        'no_default' => false,
        'comments' => '',
...
$dictionary['oj_Events']['fields']['event_group_c']['required'] = true;
...
?>
<?php
// Merged from custom/Extension/modules/oj_Events/Ext/Vardefs/twitter_account.php


$dictionary['oj_Events']['fields']['twitter_account'] = array(
    'name' => 'twitter_account',
    'type' => 'enum',
    'vname' => 'LBL_TWITTER_ACCOUNT',
    'options' => 'twitter_account_list',
    'required' => true,
);
...
$dictionary['oj_Events']['fields']['event_full_name_c']['required']=true;
